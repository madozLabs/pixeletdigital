...
1. Confirm current launch inclusion and current/future status before reviewing labels.
2. Review Pixel&Digital service families and individual membership.
3. Review Kwaliti Print capability categories and supporting guidance.
4. Confirm Studio and Training teaser-only boundaries and wording inputs.
5. Review page placement and conversion routes.
6. Identify evidence and rights available for every retained item.
...
- Owner-stated fact: Each candidate appears in the owner-stated service catalogue draft.
- Proposed editorial grouping: Only owner-approved launch candidates proceed into the taxonomy and page mapping.
- Unresolved decision: Current launch inclusion and exact public name for every candidate.
- Evidence needed: Approved scope/exclusions and permissioned proof per retained service.
...
Rationale / blocker / downstream action: ______________________________________
...
- Unresolved decision: Label, membership, launch inclusion and boundaries among services.
- Evidence needed: Service-specific scope, examples, outcomes where available and rights.
...
- Owner-stated fact: Audiovisual Production is supported by an existing photo/video studio.
- Proposed editorial grouping: Standalone agency family; no implied Studio launch.
- Unresolved decision: Launch inclusion, exact scope, boundaries with Motion Design and Video Editing, and Studio distinction.
- Evidence needed: Approved production scope, evidence of the studio safe to publish, permissioned work and rights.
...
- Owner-stated fact: Personalized Gadgets is currently stated as available; Banner Printing, Vinyl Printing and 3D Lettering/CNC are future capabilities.
- Proposed editorial grouping: One candidate current category; three future-only records.
- Unresolved decision: Current availability, public names and launch inclusion for each category.
- Evidence needed: Operational confirmation, options/constraints, authentic examples, rights and file guidance.
...
- Owner-stated fact: Banner Printing, Vinyl Printing and 3D Lettering/CNC are future capabilities.
- Proposed editorial grouping: All three remain future-only, outside current capability discovery and quotation routes.
- Unresolved decision: Whether it should be mentioned before operational readiness and what status wording is safe.
- Evidence needed: Operational readiness, materials/process/constraints, authentic evidence, rights and approved status wording.
...
Rationale / downstream action: ________________________________________________
...
- Owner-stated fact: No standalone guidance service is owner-stated; the existing draft labels the grouping as proposed.
- Proposed editorial grouping: Supporting content governed per parent capability.
- Unresolved decision: Whether enough validated content exists and whether an index is useful.
- Evidence needed: Operational approval, source, limits, definitions, review date and approved file guidance.
...
- Owner-stated fact: The service candidates are owner-stated; no family, page count or work evidence is approved.
- Proposed editorial grouping: Overview â†’ family/detail â†’ relevant proof â†’ contextual project enquiry.
- Unresolved decision: Which family pages are useful, retained service details, ordering, relationships and proof availability.
- Evidence needed: Approved scopes, relationships, work, outcomes where available, rights and content variants.
...
- Owner-stated fact: Candidate capability entries are owner-stated; exact options, constraints, examples and quotation inputs are not approved.
- Proposed editorial grouping: Overview â†’ current capability detail/guidance â†’ relevant example â†’ contextual quotation.
- Unresolved decision: Retained pages, current status, guidance depth, examples, qualification questions and file handling.
- Evidence needed: Operational facts, constraints, examples, rights, file guidance and commercial-owner journey approval.
...
- Unresolved decision: Name, identity, wording, status and contact action.
- Evidence needed: Approved wording/status and rights-cleared identity/media.
...
- Owner-stated fact: Contact, project, quotation and consultation intents are identified, but final route and wording are unresolved.
- Proposed editorial grouping: Intent-based routes with retained context.
- Unresolved decision: Which routes launch, consultation approach, questions, routing, next-step wording and teaser contact action.
- Evidence needed: Commercial-owner approval and legal/privacy-reviewed form content and handling.
...
- Owner-stated fact: No approved client evidence, metric or testimonial is present in the reviewed drafts.
- Proposed editorial grouping: Evidence is governed per service/capability and placed near the statement it supports.
- Unresolved decision: Which projects, examples, clients, outcomes, testimonials and media are authorized.
- Evidence needed: Authentic deliverables, client permission, attributable outcomes, exact testimonial permission and media rights.
...
- Owner-stated fact: ODR-001 and ODR-004 through ODR-007, ODR-014, ODR-015, ODR-018, ODR-019 and ODR-022 are open.
- Proposed editorial grouping: Treat these as explicit release dependencies, not content blanks to fill editorially.
- Unresolved decision: The approved answer, authority, implications and review date for every applicable ODR item.
- Evidence needed: Owner decisions plus legal, privacy, operational and rights authority as applicable.
...
- Deferrals identify blocker, next owner and review trigger: Yes `[ ]` No `[ ]` Not applicable `[ ]`
- Rejections identify downstream removals/changes: Yes `[ ]` No `[ ]` Not applicable `[ ]`
- Service/capability facts checked against owner statements: Yes `[ ]` No `[ ]`
- Studio and Training remain teaser/foundation only: Yes `[ ]` No `[ ]`
- Evidence and rights gaps remain visibly blocked: Yes `[ ]` No `[ ]`
- Applicable ODR items updated separately before publication: Yes `[ ]` No `[ ]`

Final reviewer: ____________________ Review date: ____________________

Contradictions or follow-up actions: ___________________________________________
