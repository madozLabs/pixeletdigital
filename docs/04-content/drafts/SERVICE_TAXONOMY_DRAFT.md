# Service Taxonomy Draft

Status: Provisional working draft; owner review required; not approved for publication
Scope: Pixel&Digital and Kwaliti Print are live MVP worlds. Studio and Training remain teaser/foundation only.
Sources: owner-stated entries in the existing content drafts, interpreted within the approved information-architecture and governance boundaries.

## Use and publication rule
...
- **Publication gate:** Owner approval under ODR-002; evidence and attribution approval under ODR-014 and ODR-015; approved conversion route under ODR-005; applicable language, geography, pricing, legal and privacy decisions closed.
...
- **Publication gate:** Owner approval under ODR-002; evidence and rights approval under ODR-014 and ODR-015; approved conversion route under ODR-005; applicable language, geography, pricing, legal and privacy decisions closed.

### 3. Audiovisual production

- **Owner-stated fact:** Audiovisual Production, supported by an existing photo/video studio.
- **Proposed editorial grouping:** Retain Audiovisual Production as a provisional standalone Pixel&Digital service family because no additional owner-stated service belongs safely beneath it. This does not approve the future Studio as a live world or transfer the service to it.
- **Unresolved decision:** Confirm launch inclusion, exact agency scope, exclusions, relationship to Motion Design and Video Editing, evidence, rights and the wording that distinguishes the agency capability from the future Studio identity.
- **Evidence needed:** Approved production scope; evidence of the existing photo/video studio that is safe to publish; permissioned work and media; responsibility, rights and delivery boundaries; attributable outcomes where available.
...
- **Publication gate:** Blocked until explicit owner approval under ODR-003 and complete operational, evidence, rights, conversion, legal and privacy review. Future status alone is insufficient for publication as an available capability.

### 8. Production and fabrication guidance

- **Owner-stated fact:** No standalone service is owner-stated. The source draft proposes practical guidance on materials, formats, finishing and file preparation for confirmed Kwaliti Print capabilities.
- **Proposed editorial grouping:** Treat guidance as supporting content attached only to approved capability records, not as a separate offer or capability family.
- **Unresolved decision:** Confirm whether this supporting grouping is useful; approve each fact, limit, definition, review date and relationship to a confirmed capability.
- **Evidence needed:** Operational-owner validation of every guidance item; source and fact-check date; accessible static explanation; approved file-acceptance instructions where relevant.
- **Conversion implication:** Approved guidance may reduce ambiguity before a contextual quotation request. It must not imply inventory, feasibility, capacity, lead time or accepted file formats that have not been approved.
- **Publication gate:** Each guidance item is blocked until its parent capability is approved under ODR-003, its operational facts are validated, and file guidance under ODR-022 plus applicable conversion, legal and privacy gates are closed.

## Studio and Training foundations
...
- **Publication gate:** ODR-008 must be approved. Expansion remains blocked unless ODR-009 explicitly changes scope.
...
- **Publication gate:** ODR-010 must be approved. Expansion remains blocked unless ODR-011 explicitly changes scope.

## Taxonomy-wide unresolved decisions

All labels and groupings remain provisional pending ODR-002 and ODR-003. Public use also depends on the relevant open decisions for positioning, pricing, consultation, languages, geography, evidence, media, legal identity, privacy/retention and file acceptance. No grouping closes those decisions by implication.
